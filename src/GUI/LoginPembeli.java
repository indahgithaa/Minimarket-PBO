...
public class LoginPembeli extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Silakan masukan username dan password rahasia Anda.");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        //pindah ke halaman DaftarPembeli
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        //login dari pembeli.txt
        BufferedReader reader;

        try {
            reader = new BufferedReader(new FileReader("pembeli.txt"));
            String line = reader.readLine();

            while (line != null) {
                String[] data = line.split(",");
                if (data[0].equals(username) && data[2].equals(password)) {
                    for (Konsumen pembeli : Konsumen.listKonsumen) {
                        if (pembeli.getNama().equals(data[0])) {
                            new HomePembeli(pembeli).setVisible(true);
                            this.dispose();
                        }
                    }
                }
        ...
        // pindah ke halaman HomePembeli
    }

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // pindah ke halaman loginGuest
        new HomePembeli(null).setVisible(true);
        this.dispose();
